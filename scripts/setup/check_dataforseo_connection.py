...
# -*- coding: utf-8 -*-
"""
DataForSEO API connectivity check (manual setup tool - live API call).

Run after filling DATAFORSEO_LOGIN/PASSWORD in .env:
    python3 scripts/setup/check_dataforseo_connection.py
...
def check_dataforseo_connection():
...
def main():
    """Fonction principale."""
    success = check_dataforseo_connection()
